...
const Navbar = () => {
  return (
    <nav className="container ">
      <div className="flex justify-between items-center mx-auto  bg-gradient-to-r from-[#3BA29B] to-[#E4FDE5] pt-[2rem] pb-[1rem] px-20 w-[100vw]">
        ...
        <button
          className="hidden md:flex custom__button hover:bg-gradient-to-r from-[#68baaf] to-[#95bbb2]  mr-12"
          type="submit"
        >
          Notify Me
        </button>
